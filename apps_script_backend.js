...
const CONFIG = {
  ...
  COURT_SLOTS: {
    // 🚫 CEC 1 BLOQUEADA — mal estado de cancha (reactivar manualmente cuando esté lista)
    cec1: {
      1: [], 2: [], 3: [], 4: [], 5: [], 6: [], 0: []
    },
    // 🚫 CEC 2 BLOQUEADA — mal estado de cancha (reactivar manualmente cuando esté lista)
    cec2: {
      1: [], 2: [], 3: [], 4: [], 5: [], 6: [], 0: []
    },
    cjp1: {
